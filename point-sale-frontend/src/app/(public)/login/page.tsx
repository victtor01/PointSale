  ...
  return (
    ...
    >
      <header className={`${fontSaira} grid gap-2`}>
        <h1 className="text-[1.4rem] text-gray-500 dark:text-white font-semibold text-center">Entre com o google ou faça login para continuar!</h1>
      </header>
      ...
      <footer className="flex w-full mt-4">
        <button className="bg-indigo-600 w-full transition-opacity duration-300 rounded dark:bg-violet-600 text-white opacity-90 hover:opacity-100 p-2 py-3">
          Entrar
        </button>
      </footer>
    </div>
